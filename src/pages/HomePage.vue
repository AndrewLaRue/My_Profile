...
import ProjectMagic from "../components/ProjectMagic.vue";
export default {
  setup() {
    return {
  ...
  components: { ProjectSiteClone, ProjectMoonMiner, ProjectWayfinder, ProjectInspire, ProjectNetwork, ProjectTower, ProjectMagic }
}
</script>
